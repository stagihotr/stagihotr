...
const MappingEntry scope_36_entries[34] = {
    ...
    /* 3 */ { MAP_LOCAL, "_L1", NULL, sizeof(T_String_06), (size_t)&outputs_ctx._L1_Protocol_1, &_Type_T_String_06_Utils, NULL, NULL, &scope_37, 1, 3 },
    /* 4 */ { MAP_LOCAL, "_L2", NULL, sizeof(T_String_06), (size_t)&outputs_ctx._L2_Protocol_1, &_Type_T_String_06_Utils, NULL, NULL, &scope_37, 1, 4 },
    /* 5 */ { MAP_LOCAL, "_L3", NULL, sizeof(T_String_06), (size_t)&outputs_ctx._L3_Protocol_1, &_Type_T_String_06_Utils, NULL, NULL, &scope_37, 1, 5 },
    /* 6 */ { MAP_LOCAL, "_L4", NULL, sizeof(T_String_06), (size_t)&outputs_ctx._L4_Protocol_1, &_Type_T_String_06_Utils, NULL, NULL, &scope_37, 1, 6 },
    /* 7 */ { MAP_LOCAL, "_L7", NULL, sizeof(T_String_43), (size_t)&outputs_ctx._L7_Protocol_1, &_Type_T_String_43_Utils, NULL, NULL, &scope_38, 1, 7 },
    /* 8 */ { MAP_LOCAL, "_L9", NULL, sizeof(T_String_01), (size_t)&outputs_ctx._L9_Protocol_1, &_Type_T_String_01_Utils, NULL, NULL, &scope_9, 1, 8 },
    /* 9 */ { MAP_LOCAL, "_L11", NULL, sizeof(T_String_01), (size_t)&outputs_ctx._L11_Protocol_1, &_Type_T_String_01_Utils, NULL, NULL, &scope_9, 1, 9 },
    /* 10 */ { MAP_LOCAL, "_L13", NULL, sizeof(T_String_10), (size_t)&outputs_ctx._L13_Protocol_1, &_Type_T_String_10_Utils, NULL, NULL, &scope_4, 1, 10 },
    /* 11 */ { MAP_LOCAL, "_L14", NULL, sizeof(T_String_32), (size_t)&outputs_ctx._L14_Protocol_1, &_Type_T_String_32_Utils, NULL, NULL, &scope_39, 1, 11 },
    /* 12 */ { MAP_LOCAL, "_L16", NULL, sizeof(array_char_75), (size_t)&outputs_ctx._L16_Protocol_1, &_Type_array_char_75_Utils, NULL, NULL, &scope_40, 1, 12 },
    /* 13 */ { MAP_LOCAL, "_L17", NULL, sizeof(array_char_9), (size_t)&outputs_ctx._L17_Protocol_1, &_Type_array_char_9_Utils, NULL, NULL, &scope_41, 1, 13 },
    /* 14 */ { MAP_LOCAL, "_L24", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L24_Protocol_1, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 14 },
    /* 15 */ { MAP_LOCAL, "_L30", NULL, sizeof(kcg_uint16), (size_t)&outputs_ctx._L30_Protocol_1, &_Type_kcg_uint16_Utils, NULL, NULL, NULL, 1, 15 },
    /* 16 */ { MAP_LOCAL, "_L32", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L32_Protocol_1, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 16 },
    /* 17 */ { MAP_LOCAL, "_L33", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L33_Protocol_1, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 17 },
    /* 18 */ { MAP_LOCAL, "_L34", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L34_Protocol_1, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 18 },
    /* 19 */ { MAP_LOCAL, "_L39", NULL, sizeof(S_ToLabel_33), (size_t)&outputs_ctx._L39_Protocol_1, &_Type_S_ToLabel_33_Utils, NULL, NULL, &scope_7, 1, 19 },
    /* 20 */ { MAP_LOCAL, "_L40", NULL, sizeof(S_ToLabel_76), (size_t)&outputs_ctx._L40_Protocol_1, &_Type_S_ToLabel_76_Utils, NULL, NULL, &scope_5, 1, 20 },
    /* 21 */ { MAP_LOCAL, "_L41", NULL, sizeof(kcg_uint16), (size_t)&outputs_ctx._L41_Protocol_1, &_Type_kcg_uint16_Utils, NULL, NULL, NULL, 1, 21 },
    /* 22 */ { MAP_LOCAL, "_L42", NULL, sizeof(kcg_uint16), (size_t)&outputs_ctx._L42_Protocol_1, &_Type_kcg_uint16_Utils, NULL, NULL, NULL, 1, 22 },
    /* 23 */ { MAP_LOCAL, "_L44", NULL, sizeof(S_ToLabel_10), (size_t)&outputs_ctx._L44_Protocol_1, &_Type_S_ToLabel_10_Utils, NULL, NULL, &scope_3, 1, 23 },
    /* 24 */ { MAP_LOCAL, "_L45", NULL, sizeof(T_String_10), (size_t)&outputs_ctx._L45_Protocol_1, &_Type_T_String_10_Utils, NULL, NULL, &scope_4, 1, 24 },
    /* 25 */ { MAP_LOCAL, "_L46", NULL, sizeof(T_String_01), (size_t)&outputs_ctx._L46_Protocol_1, &_Type_T_String_01_Utils, NULL, NULL, &scope_9, 1, 25 },
    /* 26 */ { MAP_LOCAL, "_L47", NULL, sizeof(T_String_33), (size_t)&outputs_ctx._L47_Protocol_1, &_Type_T_String_33_Utils, NULL, NULL, &scope_8, 1, 26 },
    /* 27 */ { MAP_LOCAL, "_L48", NULL, sizeof(T_String_76), (size_t)&outputs_ctx._L48_Protocol_1, &_Type_T_String_76_Utils, NULL, NULL, &scope_6, 1, 27 },
    /* 28 */ { MAP_LOCAL, "_L49", NULL, sizeof(T_String_01), (size_t)&outputs_ctx._L49_Protocol_1, &_Type_T_String_01_Utils, NULL, NULL, &scope_9, 1, 28 },
    /* 29 */ { MAP_LOCAL, "_L51", NULL, sizeof(T_String_01), (size_t)&outputs_ctx._L51_Protocol_1, &_Type_T_String_01_Utils, NULL, NULL, &scope_9, 1, 29 },
    /* 30 */ { MAP_LOCAL, "_L52", NULL, sizeof(T_String_02), (size_t)&outputs_ctx._L52_Protocol_1, &_Type_T_String_02_Utils, NULL, NULL, &scope_10, 1, 30 },
    /* 31 */ { MAP_LOCAL, "_L53", NULL, sizeof(T_String_02), (size_t)&outputs_ctx._L53_Protocol_1, &_Type_T_String_02_Utils, NULL, NULL, &scope_10, 1, 31 },
    /* 32 */ { MAP_LOCAL, "_L54", NULL, sizeof(T_String_01), (size_t)&outputs_ctx._L54_Protocol_1, &_Type_T_String_01_Utils, NULL, NULL, &scope_9, 1, 32 },
    /* 33 */ { MAP_LOCAL, "_L56", NULL, sizeof(T_String_03), (size_t)&outputs_ctx._L56_Protocol_1, &_Type_T_String_03_Utils, NULL, NULL, &scope_11, 1, 33 }
};
...
const MappingEntry scope_21_entries[9] = {
...
const MappingEntry scope_1_entries[49] = {
    ...
    /* 6 */ { MAP_INPUT, "walkStart", NULL, sizeof(kcg_bool), (size_t)&inputs_ctx.walkStart, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 6 },
    /* 7 */ { MAP_INPUT, "walkStop", NULL, sizeof(kcg_bool), (size_t)&inputs_ctx.walkStop, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 7 },
    /* 8 */ { MAP_INPUT, "walkSteps", NULL, sizeof(T_String_01), (size_t)&inputs_ctx.walkSteps, &_Type_T_String_01_Utils, NULL, NULL, &scope_9, 1, 8 },
    /* 9 */ { MAP_INPUT, "walkMagnitude", NULL, sizeof(T_String_01), (size_t)&inputs_ctx.walkMagnitude, &_Type_T_String_01_Utils, NULL, NULL, &scope_9, 1, 9 },
    /* 10 */ { MAP_INPUT, "sitStart", NULL, sizeof(kcg_bool), (size_t)&inputs_ctx.sitStart, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 10 },
    /* 11 */ { MAP_INPUT, "raiseStart", NULL, sizeof(kcg_bool), (size_t)&inputs_ctx.raiseStart, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 11 },
    /* 12 */ { MAP_INPUT, "StepsNotification", NULL, sizeof(kcg_bool), (size_t)&inputs_ctx.StepsNotification, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 12 },
    /* 13 */ { MAP_INPUT, "MagnitudeNotification", NULL, sizeof(kcg_bool), (size_t)&inputs_ctx.MagnitudeNotification, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 13 },
    /* 14 */ { MAP_LOCAL, "Magnitude", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx.Magnitude, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 14 },
    /* 15 */ { MAP_LOCAL, "Steps", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx.Steps, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 15 },
    /* 16 */ { MAP_LOCAL, "varDoneRunning", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx.varDoneRunning, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 16 },
    /* 17 */ { MAP_LOCAL, "varWaiting", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx.varWaiting, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 17 },
    /* 18 */ { MAP_LOCAL, "ImageReference", NULL, sizeof(T_ImageReference), (size_t)&outputs_ctx.ImageReference, &_Type_T_ImageReference_Utils, NULL, NULL, &scope_2, 1, 18 },
    /* 19 */ { MAP_LOCAL, "varDoneSitting", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx.varDoneSitting, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 19 },
    /* 20 */ { MAP_LOCAL, "varDoneRising", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx.varDoneRising, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 20 },
    /* 21 */ { MAP_LOCAL, "currentStatus", NULL, sizeof(T_String_02), (size_t)&outputs_ctx.currentStatus, &_Type_T_String_02_Utils, NULL, NULL, &scope_10, 1, 21 },
    /* 22 */ { MAP_LOCAL, "currentCommand", NULL, sizeof(T_String_02), (size_t)&outputs_ctx.currentCommand, &_Type_T_String_02_Utils, NULL, NULL, &scope_10, 1, 22 },
    /* 23 */ { MAP_LOCAL, "_L37", NULL, sizeof(T_ImageReference), (size_t)&outputs_ctx._L37, &_Type_T_ImageReference_Utils, NULL, NULL, &scope_2, 1, 23 },
    /* 24 */ { MAP_LOCAL, "_L43", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L43, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 24 },
    /* 25 */ { MAP_LOCAL, "_L44", NULL, sizeof(T_String_02), (size_t)&outputs_ctx._L44, &_Type_T_String_02_Utils, NULL, NULL, &scope_10, 1, 25 },
    /* 26 */ { MAP_LOCAL, "_L45", NULL, sizeof(T_String_02), (size_t)&outputs_ctx._L45, &_Type_T_String_02_Utils, NULL, NULL, &scope_10, 1, 26 },
    /* 27 */ { MAP_LOCAL, "_L18", NULL, sizeof(T_String_01), (size_t)&outputs_ctx._L18, &_Type_T_String_01_Utils, NULL, NULL, &scope_9, 1, 27 },
    /* 28 */ { MAP_LOCAL, "_L15", NULL, sizeof(T_String_01), (size_t)&outputs_ctx._L15, &_Type_T_String_01_Utils, NULL, NULL, &scope_9, 1, 28 },
    /* 29 */ { MAP_LOCAL, "_L51", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L51, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 29 },
    /* 30 */ { MAP_LOCAL, "_L52", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L52, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 30 },
    /* 31 */ { MAP_LOCAL, "_L55", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L55, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 31 },
    /* 32 */ { MAP_LOCAL, "_L59", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L59, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 32 },
    /* 33 */ { MAP_LOCAL, "_L42", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L42, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 33 },
    /* 34 */ { MAP_LOCAL, "_L41", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L41, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 34 },
    /* 35 */ { MAP_LOCAL, "_L62", NULL, sizeof(S_ToLabel_76), (size_t)&outputs_ctx._L62, &_Type_S_ToLabel_76_Utils, NULL, NULL, &scope_5, 1, 35 },
    /* 36 */ { MAP_LOCAL, "_L63", NULL, sizeof(S_ToLabel_33), (size_t)&outputs_ctx._L63, &_Type_S_ToLabel_33_Utils, NULL, NULL, &scope_7, 1, 36 },
    /* 37 */ { MAP_LOCAL, "_L64", NULL, sizeof(S_ToLabel_10), (size_t)&outputs_ctx._L64, &_Type_S_ToLabel_10_Utils, NULL, NULL, &scope_3, 1, 37 },
    /* 38 */ { MAP_LOCAL, "_L78", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L78, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 38 },
    /* 39 */ { MAP_LOCAL, "_L79", NULL, sizeof(T_String_01), (size_t)&outputs_ctx._L79, &_Type_T_String_01_Utils, NULL, NULL, &scope_9, 1, 39 },
    /* 40 */ { MAP_LOCAL, "_L81", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L81, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 40 },
    /* 41 */ { MAP_LOCAL, "_L84", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L84, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 41 },
    /* 42 */ { MAP_LOCAL, "_L85", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L85, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 42 },
    /* 43 */ { MAP_LOCAL, "_L86", NULL, sizeof(T_String_03), (size_t)&outputs_ctx._L86, &_Type_T_String_03_Utils, NULL, NULL, &scope_11, 1, 43 },
    /* 44 */ { MAP_AUTOMATON, "SM1:", NULL, 0, 0, NULL, NULL, NULL, &scope_12, 1, 44 },
    /* 45 */ { MAP_EXPANDED, "Read_InputNumber 1", NULL, 0, 0, NULL, NULL, NULL, &scope_33, 1, 45 },
    /* 46 */ { MAP_EXPANDED, "Read_InputNumber 5", NULL, 0, 0, NULL, NULL, NULL, &scope_34, 1, 46 },
    /* 47 */ { MAP_EXPANDED, "DisplayView 1", NULL, 0, 0, NULL, NULL, NULL, &scope_35, 1, 47 },
    /* 48 */ { MAP_EXPANDED, "Protocol 1", NULL, 0, 0, NULL, NULL, NULL, &scope_36, 1, 48 }
};
