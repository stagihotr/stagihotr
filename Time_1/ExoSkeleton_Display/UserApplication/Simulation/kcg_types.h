...
/* Read_InputNumber/, T_String_02/ */
typedef kcg_char T_String_02[2];

/* Protocol/, Protocol/value/, T_String_76/ */
typedef kcg_char T_String_76[76];

typedef kcg_char array_char_24[24];

/* Protocol/, Protocol/value/, T_String_33/ */
typedef kcg_char T_String_33[33];

typedef kcg_char array_char_7[7];
...
/* Protocol/, T_String_43/ */
typedef kcg_char T_String_43[43];

typedef kcg_char array_char_9[9];

typedef kcg_char array_char_18[18];

/* T_String_01/ */
typedef kcg_char T_String_01[1];

/* Protocol/, Protocol/value/, T_String_10/ */
typedef kcg_char T_String_10[10];

typedef kcg_char array_char_75[75];

/* Protocol/, S_ToLabel_76/ */
...
/* Main/SM1:Running:, Main/SM1:Waiting:, T_ImageReference/, Transition/ */
typedef struct kcg_tag_T_ImageReference {
  kcg_bool Emit2DF;
  kcg_uint16 Reference;
} T_ImageReference;

/* Protocol/, S_ToLabel_33/ */
...
#ifndef kcg_copy_array_char_75
#define kcg_copy_array_char_75(kcg_C1, kcg_C2)                                \
  (kcg_assign_array((kcg_C1), (kcg_C2), sizeof (array_char_75)))
#endif /* kcg_copy_array_char_75 */
...
#ifndef kcg_copy_array_char_18
#define kcg_copy_array_char_18(kcg_C1, kcg_C2)                                \
  (kcg_assign_array((kcg_C1), (kcg_C2), sizeof (array_char_18)))
#endif /* kcg_copy_array_char_18 */
...
#ifndef kcg_copy_array_char_7
#define kcg_copy_array_char_7(kcg_C1, kcg_C2)                                 \
  (kcg_assign_array((kcg_C1), (kcg_C2), sizeof (array_char_7)))
#endif /* kcg_copy_array_char_7 */
...
#ifndef kcg_copy_array_char_24
#define kcg_copy_array_char_24(kcg_C1, kcg_C2)                                \
  (kcg_assign_array((kcg_C1), (kcg_C2), sizeof (array_char_24)))
#endif /* kcg_copy_array_char_24 */
...
#ifndef kcg_comp_array_char_75
extern kcg_bool kcg_comp_array_char_75(
  array_char_75 *kcg_c1,
  array_char_75 *kcg_c2);
...
#ifndef kcg_comp_array_char_18
extern kcg_bool kcg_comp_array_char_18(
  array_char_18 *kcg_c1,
  array_char_18 *kcg_c2);
#endif /* kcg_comp_array_char_18 */
...
#ifndef kcg_comp_array_char_7
extern kcg_bool kcg_comp_array_char_7(
  array_char_7 *kcg_c1,
  array_char_7 *kcg_c2);
#endif /* kcg_comp_array_char_7 */
...
#ifndef kcg_comp_array_char_24
extern kcg_bool kcg_comp_array_char_24(
  array_char_24 *kcg_c1,
  array_char_24 *kcg_c2);
#endif /* kcg_comp_array_char_24 */
